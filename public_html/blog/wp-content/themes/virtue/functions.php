...
require_once locate_template('/lib/viewcount.php'); 			    // Page View Count
require_once locate_template('/lib/viewcount-admin.php'); 			// Page View Count Admin Panel
require_once locate_template('/lib/exclude-category.php'); 			// Exclude Category from Sidebar Widget


function paginate_links_reworked( $args = '' ) {
