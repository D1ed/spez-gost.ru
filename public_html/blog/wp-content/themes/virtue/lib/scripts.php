...
function kadence_scripts() {
	...
	wp_enqueue_style('bootstrap', esc_url(getDomain()) . '/assets/modules/css/bootstrap.min.css', false);
	...
	wp_enqueue_style('cms-style', esc_url(getDomain()) . '/css/home_and_store/cms-style.css', false);
	wp_enqueue_style('icon-font', get_template_directory_uri() . '/assets/fonts/icon-fonts/style.css', false);
	wp_enqueue_style('style-main', esc_url(getDomain()) . '/assets/modules/css/style.css', false);
	wp_enqueue_style('style-child', get_template_directory_uri() . '/assets/css/virtue-sas.css', false, null);
	...
	wp_register_script('bootstrap', esc_url(getDomain()) . '/assets/modules/js/bootstrap.min.js', false, null, false);
	wp_register_script('blog-scripts', get_template_directory_uri() . '/assets/js/blog-scripts.js', false, null, false);
