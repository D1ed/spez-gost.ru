<header>
   <div class="top-menu_p <?php if ($aurus_header_var ==2) { ?>header_v_2<?php } ?><?php if ($aurus_header_var ==3) { ?>header_v3<?php } ?>">
      ...
      <div id="top-menu">
         <div class="container nobackground">
            <div class="row vertical-align">
               ...
               <div class="logo_v2 col-xs-3 col-sm-4 col-md-2 <?php if ($aurus_logo_width !=1) { ?> col-lg-2 <?php } else { ?> col-lg-1 <?php } ?>">
                  <div id="logo">
                     <?php if ($logo) { ?>
                     <?php if ($home == $og_url) { ?>
               ...
               <nav id="menu" class="header_v2 col-md-7 <?php if ($aurus_logo_width !=1) { ?> col-lg-10 <?php } else { ?> col-lg-9 <?php } ?> visible-md visible-lg" >
                  <div class="collapse navbar-collapse navbar-ex1-collapse">
                     ...
                     <ul class="nav navbar-nav">
                        <li class="dropdown hidev <?php if ($aurus_seevmenuw !=1) { ?>seevmenuw <?php } ?> <?php if ($class == 'common-home' && $aurus_seevmenu_menu_open !=1){?> open <?php } ?> ">
                           ...
                           <ul id="menu_height" class="fix_sc <?php if ($class != 'common-home' && $aurus_ico_home !=1) { ?> home <?php } else { ?>home1<?php } ?> dropdown-menu <?php if ($aurus_seevmenu_menu_open !=1) { ?> fix_scrollmenu <?php } ?> multi-level" role="menu">
