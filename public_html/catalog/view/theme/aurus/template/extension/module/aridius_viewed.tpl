...
<?php if ($colleft != 1 && $carusel != 1 ) { ?>
<div id="veiwed-grid" class="bl_margin flex_height_row">
   <?php foreach ($products as $product) { ?>
   <div class="product-layout <?php if ($column_left || $column_right ) { ?> nth1 <?php } else { ?> nth2 <?php } ?> veiwed <?php if ($column_left || $column_right ) { ?> col-xl-five col-lg-3 col-md-4 col-sm-4 col-xs-6 <?php } else { ?> col-xl-2 col-lg-five col-md-3 col-sm-4 col-xs-6 <?php } ?>">
...
<script>
   ...
   var size_li_veiw = $("#veiwed-grid > div").size();
   var li_element_veiw  = <?php if ($column_left || $column_right ) { ?>5<?php } else { ?>6<?php } ?>;
   if(li_element_veiw !=size_li_veiw){
   $( ".product-layout.veiwed:nth-child(<?php if ($column_left || $column_right ) { ?>5<?php } else { ?>6<?php } ?>n):not(:last-child)" ).append('<div class="gridcount veiwed"><i class="gridcount_load fa fa-refresh fa-lg"></i><span class="gridcount2"><?php echo $button_load; ?></span></div>');
   $(".product-layout.veiwed:nth-child(<?php if ($column_left || $column_right ) { ?>5<?php } else { ?>6<?php } ?>n):not(:last-child)").addClass("veiwed_box quickview_hidden");
   }
   $('#veiwed-grid > div:lt('+li_element_veiw+')').fadeIn('slow');
   $('.gridcount.veiwed').click(function () {
   $(this).remove();
   $('.veiwed_box.quickview_hidden').first().removeClass('quickview_hidden')
   if(li_element_veiw==size_li_veiw){
   $('.btn.btn-default.gridcount.veiwed').remove();
   }else{
   li_element_veiw = (li_element_veiw+<?php if ($column_left || $column_right ) { ?>5<?php } else { ?>5<?php } ?> <= size_li_veiw) ? li_element_veiw+<?php if ($column_left || $column_right ) { ?>5<?php } else { ?>6<?php } ?> : size_li_veiw;
   $('#veiwed-grid > div:lt('+li_element_veiw+')').fadeIn('slow');
   }
...
<?php  } elseif ($colleft != 1 && $carusel == 1) { ?>
<div id="veiwedc_carusel<?php echo $module; ?>" class="swiper-container">
   ...
   <?php if ($navigation) { ?>
   <div class="#veiwedc_carusel<?php echo $module; ?> swiper-button-next"><i class="fa fa-chevron-right fa-5x"></i></div>
   <div class="#veiwedc_carusel<?php echo $module; ?> swiper-button-prev"><i class="fa fa-chevron-left fa-5x"></i></div>
   <?php } ?>
</div>
<script><!--
   $(document).ready(function () {
   var ocSwiper = new Swiper('#veiwedc_carusel<?php echo $module; ?>.swiper-container', {
   ...
   <?php if ($navigation) { ?>
   navigation: {
   nextEl: '#veiwedc_carusel<?php echo $module; ?> .swiper-button-next',
   prevEl: '#veiwedc_carusel<?php echo $module; ?> .swiper-button-prev',
   },
   <?php } ?>
   });
   <?php if ($stophover && $autoplay_on) { ?>
   $("#veiwedc_carusel<?php echo $module; ?>.swiper-container").hover(function() {
