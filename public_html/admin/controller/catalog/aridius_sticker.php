...
class ControllerCatalogAridiusSticker extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('catalog/aridius_sticker', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('catalog/aridius_sticker', 'token=' . $this->session->data['token'] . $url, true)
		);

		$data['add'] = $this->url->link('catalog/aridius_sticker/add', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('catalog/aridius_sticker/delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($results as $result) {
			$data['stickers'][] = array(
				...
				'edit'       => $this->url->link('catalog/aridius_sticker/edit', 'token=' . $this->session->data['token'] . '&sticker_id=' . $result['sticker_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('catalog/aridius_sticker', 'token=' . $this->session->data['token'] . '&sort=od.name' . $url, true);
		$data['sort_sort_order'] = $this->url->link('catalog/aridius_sticker', 'token=' . $this->session->data['token'] . '&sort=o.sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('catalog/aridius_sticker', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['sticker_id'])) {
			$data['action'] = $this->url->link('catalog/aridius_sticker/add', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('catalog/aridius_sticker/edit', 'token=' . $this->session->data['token'] . '&sticker_id=' . $this->request->get['sticker_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('catalog/aridius_sticker', 'token=' . $this->session->data['token'] . $url, true);
