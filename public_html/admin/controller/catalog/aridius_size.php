...
class ControllerCatalogAridiusSize extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('catalog/aridius_size', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('catalog/aridius_size', 'token=' . $this->session->data['token'] . $url, true)
		);

		$data['add'] = $this->url->link('catalog/aridius_size/add', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('catalog/aridius_size/delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($results as $result) {
			$data['size'][] = array(
				...
				'edit'       => $this->url->link('catalog/aridius_size/edit', 'token=' . $this->session->data['token'] . '&aridius_size_id=' . $result['aridius_size_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('catalog/aridius_size', 'token=' . $this->session->data['token'] . '&sort=od.name' . $url, true);
		...
		$pagination->url = $this->url->link('catalog/aridius_size', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['aridius_size_id'])) {
			$data['action'] = $this->url->link('catalog/aridius_size/add', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('catalog/aridius_size/edit', 'token=' . $this->session->data['token'] . '&aridius_size_id=' . $this->request->get['aridius_size_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('catalog/aridius_size', 'token=' . $this->session->data['token'] . $url, true);
