        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-api">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $entry_cheep; ?></label>
                <div class="col-sm-10">
                  <div class="btn-group" data-toggle="buttons">
                    <?php if (${$m . '_cheep'}) { ?>
                    <label class="btn btn-default"><input type="radio" name="<?php echo $m; ?>_cheep" value="0" autocomplete="off"><?php echo $text_disabled; ?></label>
                    <label class="btn btn-default active"><input type="radio" name="<?php echo $m; ?>_cheep" value="1" autocomplete="off" checked="checked"><?php echo $text_enabled; ?></label>
                    <?php } else { ?>
                    <label class="btn btn-default active"><input type="radio" name="<?php echo $m; ?>_cheep" value="0" autocomplete="off" checked="checked"><?php echo $text_disabled; ?></label>
                    <label class="btn btn-default"><input type="radio" name="<?php echo $m; ?>_cheep" value="1" autocomplete="off"><?php echo $text_enabled; ?></label>
                    <?php } ?>
                  </div>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $entry_weight_limit; ?></label>
                <div class="col-sm-10">
                  <div class="btn-group" data-toggle="buttons">
                    <?php if (${$m . '_weight_limit'}) { ?>
                    <label class="btn btn-default"><input type="radio" name="<?php echo $m; ?>_weight_limit" value="0" autocomplete="off"><?php echo $text_disabled; ?></label>
                    <label class="btn btn-default active"><input type="radio" name="<?php echo $m; ?>_weight_limit" value="1" autocomplete="off" checked="checked"><?php echo $text_enabled; ?></label>
                    <?php } else { ?>
                    <label class="btn btn-default active"><input type="radio" name="<?php echo $m; ?>_weight_limit" value="0" autocomplete="off" checked="checked"><?php echo $text_disabled; ?></label>
                    <label class="btn btn-default"><input type="radio" name="<?php echo $m; ?>_weight_limit" value="1" autocomplete="off"><?php echo $text_enabled; ?></label>
                    <?php } ?>
                  </div>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $entry_daymodifier; ?></label>
                <div class="col-sm-10">
                  <div class="btn-group" data-toggle="buttons">
                    <?php if (${$m . '_daymodifier'}) { ?>
                    <label class="btn btn-default"><input type="radio" name="<?php echo $m; ?>_daymodifier" value="0" autocomplete="off"><?php echo $text_disabled; ?></label>
                    <label class="btn btn-default active"><input type="radio" name="<?php echo $m; ?>_daymodifier" value="1" autocomplete="off" checked="checked"><?php echo $text_enabled; ?></label>
                    <?php } else { ?>
                    <label class="btn btn-default active"><input type="radio" name="<?php echo $m; ?>_daymodifier" value="0" autocomplete="off" checked="checked"><?php echo $text_disabled; ?></label>
                    <label class="btn btn-default"><input type="radio" name="<?php echo $m; ?>_daymodifier" value="1" autocomplete="off"><?php echo $text_enabled; ?></label>
                    <?php } ?>
                  </div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="well well-sm" style="height: 150px; overflow: auto; margin: 0;">
                    ...
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="<?php echo $m; ?>_services[]" value="<?php echo $service['code']; ?>" <?php if (in_array($service['code'], ${$m . '_services'})) { ?>checked="checked"<?php } ?> />
            ...
            <div class="tab-pane" id="tab-log">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="<?php echo $m; ?>_email" value="<?php echo ${$m . '_email'}; ?>" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="well well-sm" style="height: 150px; overflow: auto; margin: 0;">
                    <div class="checkbox">
                      <label><input type="checkbox" name="<?php echo $m; ?>_notify[]" value="0" <?php if (in_array(0, ${$m . '_notify'})) { ?>checked="checked"<?php } ?> /> <?php echo $text_notify_0; ?></label>
                    </div>
                    <div class="checkbox">
                      <label><input type="checkbox" name="<?php echo $m; ?>_notify[]" value="2" <?php if (in_array(2, ${$m . '_notify'})) { ?>checked="checked"<?php } ?> /> <?php echo $text_notify_2; ?></label>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <ul class="list-group">
                    ...
                    <li class="list-group-item"><?php echo $text_total_postamats; ?> <span class="label label-default"><?php echo $total_postamats; ?></span></li>
                  </ul>
                </div>
              </div>
              <div class="form-group">
                  ...
                  <table id="cities" class="table table-striped table-bordered table-hover">
                    <tbody>
                      ...
                      <tr id="city-row-<?php echo $city_row; ?>">
                        <td class="text-left">
                          <select name="<?php echo $m; ?>_pickup_countries[]" class="<?php echo $m; ?>_pickup_countries form-control" id="<?php echo $m; ?>_pickup_countries_<?php echo $city_row; ?>" onchange="getRegions(this.value, '<?php echo $city_row; ?>');">
                            <option><?php echo $text_select_country; ?></option>
                            <?php if (!empty($countries)) { ?>
                            <?php foreach ($countries as $country) { ?>
                              <option value="<?php echo $country['id']; ?>" <?php if (${$m . '_pickup_countries'}[$city_row] == $country['id']) { ?>selected="selected"<?php } ?>><?php echo $country['CountryName']; ?></option>
                            <?php } ?>
                            <?php } ?>
                          </select>
                        </td>
                        <td class="text-left">
                          ...
                          $(document).ready(function() {
                            getRegions('<?php echo ${$m . '_pickup_countries'}[$city_row]; ?>', '<?php echo $city_row; ?>', '<?php echo ${$m . '_pickup_regions'}[$city_row]; ?>');
                          });
                          </script>
                          <select name="<?php echo $m; ?>_pickup_regions[]" class="<?php echo $m; ?>_pickup_regions form-control" id="<?php echo $m; ?>_pickup_regions_<?php echo $city_row; ?>" onchange="getCities(this.value, '<?php echo $city_row; ?>', '0');"></select>
                        </td>
                        <td class="text-left">
                          <script>
                          $(document).ready(function() {
                            getCities('<?php echo ${$m . '_pickup_regions'}[$city_row]; ?>', '<?php echo $city_row; ?>', '<?php echo ${$m . '_pickup_cities'}[$city_row]; ?>');
                          });
                          </script>
                          <select name="<?php echo $m; ?>_pickup_cities[]" class="<?php echo $m; ?>_pickup_cities form-control" id="<?php echo $m; ?>_pickup_cities_<?php echo $city_row; ?>"></select>
                        </td>
                        <td class="text-right">
              ...
              <div class="row">
                <div class="col-sm-2">
                  <ul class="nav nav-pills nav-stacked" id="delivery">
                    ...
                    <li <?php if (!in_array($variant['code'], ${$m . '_admin_status'})) { ?>class="hidden"<?php } ?>><a href="#tab-delivery-<?php echo $variant['code']; ?>" data-toggle="tab"><?php echo $variant['name']; ?></a></li>
                    <?php } ?>
                  </ul>
                </div>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="well well-sm" style="height: 150px; overflow: auto; margin: 0;">
                    ...
                    <div class="checkbox">
                      <label>
                        <?php if (in_array($variant['code'], ${$m . '_admin_status'})) { ?>
                        <input type="checkbox" name="<?php echo $m; ?>_admin_status[]" value="<?php echo $variant['code']; ?>" checked="checked" />
                        <?php echo $variant['name']; ?>
                        <?php } else { ?>
                        <input type="checkbox" name="<?php echo $m; ?>_admin_status[]" value="<?php echo $variant['code']; ?>" />
                        <?php echo $variant['name']; ?>
                        <?php } ?>
                      </label>
                    </div>
...
function addCity() {
  ...
  html += '    <select name="<?php echo $m; ?>_pickup_countries[]" class="<?php echo $m; ?>_pickup_countries form-control" id="<?php echo $m; ?>_pickup_countries_' + city_row + '" onchange="getRegions(this.value, ' + city_row + ');">';
  html += '      <option><?php echo $text_select_country; ?></option>';
  <?php if (!empty($countries)) { ?>
  <?php foreach ($countries as $country) { ?>
  html += '      <option value="<?php echo $country['id']; ?>"><?php echo $country['CountryName']; ?></option>';
  <?php } ?>
  <?php } ?>
  html += '    </select>';
  html += '  </td>';
  html += '  <td class="text-left">';
  html += '    <select name="<?php echo $m; ?>_pickup_regions[]" class="<?php echo $m; ?>_pickup_regions form-control" id="<?php echo $m; ?>_pickup_regions_' + city_row + '" onchange="getCities(this.value, ' + city_row + ', 0);">';
  html += '      <option><?php echo $text_no_data; ?></option>';
  html += '    </select>';
  html += '  </td>';
  html += '  <td class="text-left">';
...
function getRegions(country_id, row, active) {
  var id = '#<?php echo $m; ?>_pickup_countries_' + row,
      html = '<option><?php echo $text_no_data; ?></option>';

  if (country_id) {
    $('#button_save').addClass('disabled');
    $(id).parent().parent().find('.<?php echo $m; ?>_pickup_regions').html(html);
    $(id).parent().parent().find('.<?php echo $m; ?>_pickup_cities').html(html);

    $.ajax({
      url: 'index.php?route=extension/shipping/<?php echo $m; ?>/getRegions&token=<?php echo $token; ?>&country_id=' + encodeURIComponent(country_id),
      dataType: 'json',
      beforeSend: function() {
...
function getCities(region_id, row, active) {
  ...
  if (region_id) {
    $.ajax({
      url: 'index.php?route=extension/shipping/<?php echo $m; ?>/getCities&token=<?php echo $token; ?>&region_id=' + encodeURIComponent(region_id),
      dataType: 'json',
      beforeSend: function() {
        $(id).after(' <i class="fa fa-circle-o-notch fa-spin"></i>');
      },
...
function updateData(current = 0, type = 0) {
  $.ajax({
    url: 'index.php?route=extension/shipping/<?php echo $m; ?>/updateData&token=<?php echo $token; ?>',
    type: 'post',
...
$('select[name=\'country_id\']').on('change', function() {
  ...
  if (country_id > 0) {
    $.ajax({
      url: 'index.php?route=extension/shipping/<?php echo $m; ?>/getRegionsTable&token=<?php echo $token; ?>&country_id=' + encodeURIComponent(country_id),
      dataType: 'json',
      success: function(json) {
        if (json['zones'] && json['zones'] != '' && json['regions'] && json['regions'] != '') {
          ...
          for (r = 0; r < json['regions'].length; r++) {
            ...
            html += '  </td>';
            html += '  <td class="text-left">';
            html += '    <select name="<?php echo $m; ?>_regions[' + json['regions'][r]['id'] + '][]" class="form-control <?php echo $m; ?>_regions" multiple style="height: 300px !important;">';
...
function updateRegionToZone(country_id) {
  $.ajax({
    url: 'index.php?route=extension/shipping/<?php echo $m; ?>/updateRegionToZone&token=<?php echo $token; ?>&country_id=' + encodeURIComponent(country_id) + '&' + $('.<?php echo $m; ?>_regions').serialize(),
    dataType: 'json',
    success: function(json) {
      $('.alert').remove();
      $('#regions').html('');
