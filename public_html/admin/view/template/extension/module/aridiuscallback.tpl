...
<a href="<?php echo $aridiuscallback; ?>" data-toggle="tooltip" title="<?php echo $text_aridiuscallback; ?>" class="btn btn-warning"><i class="fa fa-phone">&nbsp;&nbsp;<?php echo $text_aridiuscallback; ?></i></a>        
...
function apply() {
	$('#form-callback').append('<input type="hidden" id="apply" name="apply" value="1" />');
