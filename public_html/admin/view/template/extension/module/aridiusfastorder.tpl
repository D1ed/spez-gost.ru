   ...
   <div class="page-header">
      <div class="container-fluid">
         <div class="pull-right">
            <a href="<?php echo $aridiusfastorder; ?>" data-toggle="tooltip" title="<?php echo $text_aridiusfastorder; ?>" class="btn btn-warning"><i class="fa fa-shopping-cart"></i>&nbsp;&nbsp;<?php echo $text_aridiusfastorder; ?></a>        
            <button type="submit" form="form-fastorder" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i>&nbsp;&nbsp;<?php echo $button_save; ?></button> 
                     ...
                     <div class="tab-content">
                        <div id="panely1" class="tab-pane fade in active">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                 <input type="text" name="aridiusfastorder_imgw" value="<?php echo $aridiusfastorder_imgw; ?>" id="input-imgw" class="form-control" />
                              </div>
                           </div>
                           <div class="form-group">
                              <label class="col-sm-2 control-label" for="input-input_imgh"><?php echo $text_imgh; ?></label>
                              <div class="col-sm-10">
                                 <input type="text" name="aridiusfastorder_imgh" value="<?php echo $aridiusfastorder_imgh; ?>" id="input-imgh" class="form-control" />
                              </div>
                           </div>
                           <div class="form-group">
                              <label class="col-sm-2 control-label" for="input-input_descchar"><?php echo $text_descchar; ?></label>
                              <div class="col-sm-10">
                                 <input type="text" name="aridiusfastorder_descchar" value="<?php echo $aridiusfastorder_descchar; ?>" id="input-descchar" class="form-control" />
                              </div>
                           </div>
                           <div class="form-group">
...
<script><!--
   function apply() {
   	$('#form-fastorder').append('<input type="hidden" id="apply" name="apply" value="1" />');
   	$('#form-fastorder').submit();
   }
   //-->
</script>
<?php echo $footer; ?>
