<?php
// Heading
$_['heading_title']						= '<span style="color: #ffcc2b;">IML</span>';
$_['heading_title_main']				= 'IML работа с заказами';
$_['heading_title_bk_main']				= 'IML работа с заказами';
...
$_['text_iml_order_id']					= '№ заказа';
$_['text_iml_order_date_create']		= 'Дата создания';
$_['text_iml_order_date_modified']		= 'Дата изменения';
$_['text_iml_order_fio']				= 'Покупатель';
$_['text_iml_order_status']				= 'Статус IML заявки';
$_['text_order_status']					= 'Статус заказа';
$_['text_iml_order_actions']			= 'Действия';
$_['text_iml_send_order']				= 'Отправить заказ';
// Entry
...
$_['iml_service_pvz_nal']				= '(С24КО) До ПВЗ с кассовым обслуживанием';
$_['iml_service_pvz_bnal']				= '(С24) До ПВЗ предоплеченный';
$_['iml_service_courier_nal']			= '(24КО) Курьерская с кассовым обслуживанием';
$_['iml_service_courier_bnal']			= '(24) Курьерская предоплаченная';
?>