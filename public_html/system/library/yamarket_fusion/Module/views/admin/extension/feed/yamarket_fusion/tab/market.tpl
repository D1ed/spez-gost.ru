    ...
    <div class="content">
		...
		<form action="<?php echo $action; ?>" method="POST" id="form-market" class="form-horizontal">
			<div class="card" id="menu_main">
				<div class="heading-card"><div class="number">1</div><h2><?=$menu_main;?></h2></div>
				<div class="body-card">
					<!-- Start content -->
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
									<select class="form-control" name="setting[<?=$profile_id;?>][market_type]">
			...
			<div class="card" id="menu_settings">
				<div class="heading-card"><div class="number">2</div><h2><?=$menu_settings;?></h2></div>
				<div class="body-card">
					<!-- Start content -->
							<div class="form-group">
								<div class="checkbox">
				...
				<div class="card" id="menu_conditions">
					<div class="heading-card"><div class="number">3</div><h2><?=$menu_conditions;?></h2></div>
					<div class="body-card">
						<!-- Start content -->
							<div class="form-group">
								<div class="checkbox">
					...
					<div class="card" id="menu_delivery">
						<div class="heading-card"><div class="number">4</div><h2><?=$menu_delivery;?></h2></div>
						<div class="body-card">
						<!-- Start content -->
								<div class="form-group">
									...
									<div class="checkbox" id="shipment-global" <?php if ($market_type == 'Goods') { echo 'style="display:run-in;"'; }else{ echo 'style="display:none;"'; }?>>
										<label>
							...
							<div class="form-group --no-offset" <?php if ($market_type == 'Goods') { echo 'style="display:none;"'; }else{ echo 'style="display:run-in;"'; }?>>
								<div class="col-sm-12">
							...
							<div class="form-group --no-offset" <?php if ($market_type == 'Goods') { echo 'style="display:run-in;"'; }else{ echo 'style="display:none;"'; }?>> <!--shipment for goods-->
								<div class="col-sm-12">
									<div class="group-title">
										<label><?=$entry_market_delivery_global;?><span data-toggle="tooltip" title="Поддерживается мультизначения через символ ';'"></span></label>
									</div>
			...
			<div class="card" id="menu_options_main">
				<div class="heading-card"><div class="number">5</div><h2><?=$menu_options_main;?></h2></div>
				<div class="body-card">
					<!-- Start content -->
						<div class="form-group --no-offset --collapsible">
							<div class="col-xs-12">
			...
			<div class="card" id="menu_custom_tags">
				<div class="heading-card"><div class="number">6</div><h2><?=$menu_custom_tags;?></h2></div>
				<div class="body-card">
					<!-- Start content -->
						<div class="form-group --no-offset --collapsible">
							<div class="col-xs-12">
			...
			<div class="card" id="menu_category_filter">
				<div class="heading-card"><div class="number">7</div><h2><?=$menu_category_filter;?></h2></div>
				<div class="body-card">
					<!-- Start content -->
						<div class="form-group --no-offset --collapsible">
							<div class="col-xs-12">
								...
								<div id="collapse-category-additional" class="collapse">
									<table id="category-additional" class="table">
										...
										<tbody>
											...
											<tr>
												<td>
													<select class="form-control input-sm" name="setting[<?=$profile_id;?>][market_category_additional][<?=$i;?>][category_id]" data-value="<?=$category_data['category_id'];?>"><?=$cat_tree_select;?></select>
												</td>
												<?php if ($module_user->hasPermission('category_for_yml')) { ?>
												<td>
			...
			<div class="card" id="menu_markup">
				<div class="heading-card"><div class="number">8</div><h2><?=$menu_markup;?></h2></div>
				<div class="body-card">
					<!-- Start content -->
						<div class="form-group --no-offset --collapsible">
							<div class="col-xs-12">
			...
			<div class="card" id="menu_analytics">
				<div class="heading-card"><div class="number">9</div><h2><?=$menu_content;?></h2></div>
				<div class="body-card">
					<!-- Start content -->
						<div class="form-group">
			...
			<div class="card" id="menu_content">
				<div class="heading-card"><div class="number">10</div><h2><?=$menu_content;?></h2></div>
				<div class="body-card">
					<!-- Start content -->
						<div class="form-group">
							<input type="hidden" name="setting[<?=$profile_id;?>][market_custom_content]" value="">
							<label for="input-custom-content" class="col-sm-4 control-label">Произвольный контент</label>
							<div class="col-sm-8">
			...
			<div class="card" id="menu_urls">
				<div class="heading-card"><div class="number">11</div><h2><?=$menu_urls;?></h2></div>
				<div class="body-card">
					<!-- Start content -->
						<div class="form-group">
	...
	function addCustomTag(data) {
		var
			...
			html = '<tr>'
				...
				+		'</td><td>'
				+			'<select class="form-control input-sm" name="setting[<?=$profile_id;?>][custom_market_tags][' + index + '][filter_category_id]" data-select="filter_category_id">'
				+				'<option value=""><?=$text_select;?></option>'
				+				'<?=$cat_tree_select;?>'
				+			'</select>'
	...
	function addDeliveryOption(data) {
		var
			...
			html = '<tr>'
				...
				+			'</select></div>'
				+		'</td><td>'
				+			'<select class="form-control input-sm" name="setting[<?=$profile_id;?>][market_delivery_options][' + index + '][category]" data-select-category>'
				+				'<option value=""><?=$text_select;?></option>'
				+				'<?=$cat_tree_select;?>'
				+			'</select>'
	...
	function addProductPriceMarkupOption(data) {
		var
			...
			html = '<tr>'
				...
				+			'</div>'
				+		'</td><td>'
				+		'<select class="form-control input-sm" name="setting[<?=$profile_id;?>][market_purchase_price_markup_options][' + index + '][category]" data-select-category>'
				...
				+		'</td><td>'
				+			'<select class="form-control input-sm" name="setting[<?=$profile_id;?>][market_purchase_price_markup_options][' + index + '][markup_type]" data-select-markup-type>'
				+				'<option value=""><?=$text_select;?></option>'
...
<script>
	setTimeout(function(){
		document.getElementById('alert alert-danger alert-dismissible').style.display = 'none';
	}, 5000);
</script>