							  ...
							  <label class="text-center" style="display: inline-block;">
								<?php if ($links_value['product_id'] == $product_id) {   ?>
									<a style="pointer-events:none" >
										<?php if ($links_value['link_name']) { ?>
											<span class="form-control view1_product"><?php echo $links_value['name']; ?></span>
										<?php } ?>
										<?php if ($links_value['image']) { ?>
								...
								<?php } elseif (!($links_value['product_id'] == 0)) { ?>
									...
									<a href="<?php echo $links_value['href']?>" >
										<?php if ($links_value['link_name']) { ?>
											<span class="form-control view1_link" ><?php echo $links_value['name']; ?></span>
										<?php } ?>
										<?php if ($links_value['image']) { ?>
								...
								<?php } else { ?>
									<a >
										<?php if ($links_value['link_name']) { ?>
											<span class="form-control view1_noproduct"><?php echo $links_value['name']; ?></span>
										<?php } ?>
										<?php if ($links_value['image']) { ?>
