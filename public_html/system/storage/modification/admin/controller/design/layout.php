...
class ControllerDesignLayout extends Controller {
	...
	protected function getForm() {
		...
		$data['text_column_right'] = $this->language->get('text_column_right');
	                ...
	                $data['text_content_topfl']   = $this->language->get('text_content_topfl');
					$data['text_content_top1']   = $this->language->get('text_content_top1');		
					$data['text_content_top2']   = $this->language->get('text_content_top2');	
					$data['text_content_top3']   = $this->language->get('text_content_top3');	
					...
					$data['text_content_slrig1'] = $this->language->get('text_content_slrig1');	
					$data['text_content_slrig2'] = $this->language->get('text_content_slrig2');	
