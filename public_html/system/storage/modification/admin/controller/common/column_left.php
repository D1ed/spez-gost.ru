...
if ($this->user->hasPermission('access', 'catalog/suppler')) {
			...
			*/	
			...
			if ($this->user->hasPermission('access', 'catalog/aridius_size')) {
				$design[] = array(
					...
					'href'     => $this->url->link('catalog/aridius_size', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
				}
			...
			if ($this->user->hasPermission('access', 'catalog/aridius_sticker')) {
				$design[] = array(
					...
					'href'     => $this->url->link('catalog/aridius_sticker', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
					}
	...
	/* Shiptor - агрегатор доставки */
      ...
      $ll_cdek[] = [
        'name'     => '<span class="fa fa-truck fa-fw"></span> Доставка',
        'href'     => $this->url->link($ext . 'shipping/ll_cdek', $token, true),
        'children' => [],
      ];

      $ll_cdek[] = [
        'name'     => '<span class="fa fa-exchange fa-fw"></span> Обмен',
        'href'     => $this->url->link($ext . 'module/ll_cdek_exchange', $token, true),
        'children' => [],
      ];

      $ll_cdek[] = [
        'name'     => '<span class="fa fa-shopping-cart fa-fw"></span> Заказы',
        'href'     => $this->url->link($ext . 'module/ll_cdek_exchange/order', $token, true),
        'children' => [],
      ];

      $ll_cdek[] = [
        'name'     => '<span class="fa fa-book fa-fw"></span> Документация',
        'href'     => 'https://docs.lutylab.ru/ll_cdek_exchange',
        'children' => [],
      ];

      $ll_cdek[] = [
        'name'     => '<span class="fa fa-life-ring fa-fw"></span> Поддержка',
        'href'     => 'mailto:support@lutylab.ru?subject=Поддержка: СДЭК [обмен]',
        'children' => [],
      ];

      $ll_cdek[] = [
        'name'     => '<span class="fa fa-user fa-fw"></span> Кабинет СДЭК',
