...
<header id="header" class="navbar navbar-static-top">
  ...
  <ul class="nav pull-right">
			...
			<li><a href="<?php echo $undersell_status; ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo $undersell_name; ?>"><span class="label label-danger pull-left"><?php echo $undersell_total; ?></span> <i class="fa fa-bar-chart fa-lg"></i></a></li> 
			

			<li><a href="<?php echo $instock_status; ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo $instock_name; ?>"><span class="label label-danger pull-left"><?php echo $instock_total; ?></span> <i class="fa fa-bullhorn fa-lg"></i></a></li>
			

			<li><a href="<?php echo $fastorder_status; ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo $fastorder_name; ?>"><span class="label label-danger pull-left"><?php echo $fastorder_total; ?></span> <i class="fa fa-shopping-cart fa-lg"></i></a></li> 
			

		    <li><a href="<?php echo $calback_status; ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo $calback_name; ?>"><span class="label label-danger pull-left"><?php echo $calback_total; ?></span> <i class="fa fa-phone fa-lg"></i></a></li> 
