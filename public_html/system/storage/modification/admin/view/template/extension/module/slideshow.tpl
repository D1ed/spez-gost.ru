              ...
              <select name="banner_id" id="input-banner" class="form-control">
                ...
                <?php } ?>
					...
					<select name="transitionStyle" class="form-control">
									...
									<option value="2"<?php if($transitionStyle == 2) { echo ' selected="selected"'; } ?>>coverflow</option>
									<option value="3"<?php if($transitionStyle == 3) { echo ' selected="selected"'; } ?>>cube</option>
				    </select>
				    </div>
                    </div>
